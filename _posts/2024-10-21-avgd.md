...
---
#### Developed a visual language by deconstructing classic military patterns into geometric abstractions, then rebuilding them through contemporary design principles. The main rounded rectangular shape is derived from the ID tag. The system integrates structured typography with reimagined camouflage patterns, resulting in a compelling blend of tradition and modernity that embodies the timeless yet progressive spirit of military classics
